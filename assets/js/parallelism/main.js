		...
		// Main init method
			init: function() {
				...
				$(function() {
                    ...
                    // Christian: dynamically generate projects from JSON with d3.js
                    initProjects(_.settings.itemHeight);
					...
					// Mode.
						_.objects.window.on('load', function() {
                            /* 
                             * Christian: finding items moved here
                             * otherwise Chrome/Safari would initProjects afterwards
                             */
                            _.objects.items = _.objects.main.find('.item');
